...
export const modalsSlice = createSlice({
	...
	reducers: {
		...
		openDeleteMonsterModal: (state, action: PayloadAction<IMonster | undefined>) => {
...
export const { openLoginModal, closeLoginModal, openMonsterModal, closeMonsterModal, openDeleteMonsterModal, closeDeleteMonsterModal } = modalsSlice.actions
